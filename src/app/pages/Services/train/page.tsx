...
const programs = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1542773998-9325f0a098d7?auto=format&fit=crop&w=320', // Add your image path here
  },
  {
...
const TrainingPrograms = () => {
  return (
    <>
    <Carousel/>
    <h1 style={{ color: 'black', fontSize: '2.5rem', marginTop:'20px',textAlign:'center' }}>Our Traning Programs</h1>
